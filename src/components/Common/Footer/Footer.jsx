      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Colombo, Sri Lanka</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:abctest@gmail.com" className="d-block" >abctest@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9876543210" className="d-block" >0112456789</a>
          </div>
        ...
        <p className="text-light">   @ 2025. travelhigh All rights reserved </p> 
        </Col>
        </Row>
